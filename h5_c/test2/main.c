...
main(void)
{
    ...
    printf("\n");
    printf("Correct Field a : \n");
    for( i = 0; i < LENGTH; i++) printf("%d ", s1[i].a);

    printf("\n");
    printf("Correct Field b : \n");
    for( i = 0; i < LENGTH; i++) printf("%.4f ", s1[i].b);

    printf("\n");
    printf("Correct Field c : \n");
    for( i = 0; i < LENGTH; i++) printf("%.4f ", s1[i].c);
    ...
    status = H5Dwrite(dataset, s2_tid, H5S_ALL, H5S_ALL, H5P_DEFAULT, s2);
